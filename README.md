...
<style>
    ...
    /* Additional loader/checkbox styles from your previous code */
    .ml-field-checkbox { margin-bottom:10px; }
</style>
</head>
<body>
                    ...
                    <form class="ml-block-form" action="https://assets.mailerlite.com/jsonp/1660733/forms/163743863189538168/subscribe" method="post" target="_blank">
                        <div class="ml-form-formContent">
                            <div class="ml-form-fieldRow ml-last-item">
                                ...
                                <div class="ml-field-group ml-field-checkbox">
                                    <label><input type="checkbox" name="consent" value="1"> I agree to receive emails</label>
                                </div>
                            </div>
                        </div>
